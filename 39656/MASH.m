...
out4_fdBr=20*log10(abs(2*out4_f)/n+1e-10);
out4dec_fdBr=20*log10(abs(2*out4dec_f)/n+1e-10);
...
out4_fdBr_=10*log10(out4_fp+1e-20);

out4dec_fdBr_=10*log10(out4dec_fp+1e-20);
out_fdBr_=10*log10(out_fp+1e-20);


out=10.^(out4dec_fdBr_/10);
...
figure(1)
plot(time,vin,'r',time,out1,'b',time,out2,'g',time,out3,'m',time,out4,'y') 
hold on
